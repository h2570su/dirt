...
type provideStructRegistration struct {
	key typeNameKey
...
func (reg *provideStructRegistration) Key() typeNameKey { return reg.key }
func (reg *provideStructRegistration) Ctor() func() (reflect.Value, error) {
	if reg.ctor == nil {
		return func() (reflect.Value, error) {
			return reflect.Value{}, fmt.Errorf("dirt: type: %s has unsatisfied dependencies", reg.key.Ty.String())
		}
	}
	return reg.ctor
}
...
func (reg *provideStructRegistration) markDeps(rty reflect.Type, accessFromRoot func(reflect.Value) reflect.Value) {
...
// Return modified
func (reg *provideStructRegistration) resolvePossibleDeps(s *Scope) bool {
	modified := false
...
func (reg *provideStructRegistration) buildCtor(s *Scope) {
...
func (reg *provideStructRegistration) buildCtorWithHook(_ *Scope) {
	t := reg.key.Ty
